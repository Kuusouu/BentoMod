...
function Invoke-VersionBump {
    ...
    $tauriConfPath = Join-Path $RepoRoot "bentomod\tauri.conf.json"
    ...
    $packageJsonPath = Join-Path $RepoRoot "bentomod\package.json"
    ...
    git add "Cargo.toml"
    git add "Cargo.lock"
    git add "bentomod/tauri.conf.json"
    git add "bentomod/package.json"
    Pop-Location
