...
/// Get the base temp directory for VFX operations: %TEMP%/bentomod
pub fn get_vfx_temp_base() -> Result<PathBuf, String> {
    let temp_dir = std::env::temp_dir();
    let vfx_base = temp_dir.join("bentomod");
...
/// Create a step-specific temp directory: %TEMP%/bentomod/rvfx_{step_name}
...
/// Clean up all rvfx_* directories inside bentomod temp folder
