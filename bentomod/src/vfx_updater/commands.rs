...
use super::models::{AssetClassInfo, VfxSettings, VfxTempDirectories};
use super::pipeline::{
...
/// App data directory matching the rest of BentoMod: %APPDATA%/BentoMod
...
/// - Downloads into `%APPDATA%/BentoMod/usmap/<filename>` and updates
...
pub async fn vfx_check_usmap_update(force: bool) -> Result<VfxUsmapUpdateResult, String> {
    ...
    let client = reqwest::Client::builder()
        ...
        .user_agent("BentoMod-VFX-Updater")
        .build()
