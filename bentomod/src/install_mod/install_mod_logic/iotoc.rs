#![allow(dead_code)]
use crate::install_mod::install_mod_logic::pak_files::bento_dir;
...
pub fn convert_to_iostore_directory(
    ...
    if pak.force_legacy_pak {
        ...
        bento_dir(pak, to_pak_dir, mod_dir, packed_files_count)
            .map_err(|e| format!("bento_dir failed: {}", e))?;
        return Ok(());
    }
...
pub fn find_uasset_tool() -> Result<PathBuf, Box<dyn std::error::Error>> {
    ...
    let relative_paths = [
        ...
        // From workspace root
        "Bento_Gui-Revamped-TauriUpdate/uasset_toolkit/tools/UAssetTool/bin/Release/net8.0/win-x64/publish/UAssetTool.exe",
        "Bento_Gui-Revamped-TauriUpdate/uasset_toolkit/tools/UAssetTool/bin/Release/net8.0/win-x64/UAssetTool.exe",
        // From BentoMod directory
