...
const groupCharactersByHero = (characters: string[], modCounts: Record<string, number>): HeroGroup[] => {
...
const calculateModCounts = (modDetails: Record<string, ModDetailsRecord>): Record<string, number> => {
...
export default function HeroFilterDropdown({ availableCharacters, selectedCharacters, modDetails, onToggle }: HeroFilterDropdownProps) {
