						...
						<div className="modal-body">
							<div className="update-info-grid">
								<div className="mod-info-box old">
									...
									<div className="info-name" title={oldMod.path}>
										{oldName}
									</div>
								</div>
								...
								<div className="mod-info-box new">
									...
									<div className="info-name" title={newSourcePath ?? undefined}>
										{newName}
									</div>
								</div>
							</div>
									...
									<div className="install-toggle__text">
										...
										<span className="install-toggle__hint">
											{obfuscate
												...
												: "Encrypt to block FModel extraction"}
										</span>
									</div>
								</Switch>
							</div>
							...
							<div className="options-section">
								<label className="checkbox-option">
									<input
										...
										onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
											setPreserveName(e.target.checked)
										}
									/>
									<div className="option-text">
										<span className="option-title">Keep existing filename</span>
										<span className="option-desc">
											The new file will be renamed to{" "}
											<code>
												{oldCleanName}
												{newExt}
											</code>{" "}
											to preserve your load order/overrides.
										</span>
									</div>
								</label>
								...
								{!preserveName && (
									<div className="name-warning">
										<IoWarningOutline />
										<span>
											Using the new filename (<code>{newName}</code>) might
											change load order priority.
										</span>
									</div>
								)}
							</div>
