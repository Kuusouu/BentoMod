...
const TOUR_STEPS: TourStep[] = [
	{
		...
		title: "Welcome to BentoMod",
		description:
			"Your all-in-one Marvel Rivals mod manager and installer. Let's take a quick tour of the main features!",
		placement: "bottom",
	},
	{
		...
		title: "Search Mods",
		description:
			"Quickly find any installed mod by name. Use Ctrl+F to focus the search bar anytime.",
		placement: "bottom",
	},
	{
		...
		title: "Add Mods",
		description:
			"Click here or drag & drop files onto the app to install new mods. Supports .pak files, archives, and folders.",
		placement: "bottom",
	},
	{
	...
	},
	{
		...
		title: "Your Mods",
		description:
			"All your installed mods live here! Toggle them on/off, rename, change priority, right-click for more options, or select multiple for bulk actions.",
		placement: "top",
	},
	{
		...
		title: "List Controls",
		description:
			"Check for mod conflicts, switch between Grid and List views, toggle the details side-panel, and manually refresh your mod list.",
		placement: "bottom",
	},
	{
		...
		title: "VFX Updater",
		description:
			"Quickly port outdated VFX mods to the latest game version. Opens a dedicated tool that automatically extracts, converts, patches, and repacks the VFX assets so your mods keep working after game updates.",
		placement: "bottom",
	},
	{
		...
		description:
			"Create and share modpacks securely with other BentoMod users across the globe.",
		placement: "bottom",
	},
	{
		...
		title: "Tools",
		description:
			"Access additional tools like Skip Launcher, update Heroes database, re-compress mods, and other utilities.",
		placement: "bottom",
	},
	{
		...
		title: "Launch Game",
		description:
			"Launch Marvel Rivals via Steam directly from here. The app will detect when the game is running to prevent you from making any breaking changes to your mods.",
		placement: "bottom",
	},
	{
		...
		title: "Settings",
		description:
			"Configure your game path and app preferences to your liking. You can replay this tour from Settings anytime!",
		placement: "left",
	},
];
...
function computeTooltipPosition(
	...
	const calcPosition = (p: Placement): { top: number; left: number } => {
		switch (p) {
			...
			case "top":
				return {
					top: cutout.top - tooltipHeight - TOOLTIP_GAP,
					left: targetCenterX - tooltipWidth / 2,
				};
			case "right":
				return {
			...
			case "left":
				return {
					top: targetCenterY - tooltipHeight / 2,
					left: cutout.left - tooltipWidth - TOOLTIP_GAP,
				};
			default:
				return {
					top: cutout.top + cutout.height + TOOLTIP_GAP,
			...
			<AnimatePresence mode="wait">
				...
				>
					<div
						...
						style={
							{
								"--arrow-offset": `${tooltipPos.arrowOffset || 50}%`,
